...
public class BezierCurve : MonoBehaviour {
    ...
    public event System.Action<int> OnBezierPointChanged;
	...
	public void AddBezierPoint(BezierPoint point)
	{
    ...
    public Vector3[] GetPoints(int res)
    {
        List<Vector3> vPoints = new List<Vector3>();
        if (points.Length > 1)
        {
